...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        try {
            ...
            partSize = Integer.parseInt(mNewPartySizeEditText.getText().toString());
    ...
    private long addNewGuest(String guestName, int partSize) {
        ...
        contentValues.put(WaitlistContract.WaitlistEntry.COLUMN_PARTY_SIZE, partSize);
