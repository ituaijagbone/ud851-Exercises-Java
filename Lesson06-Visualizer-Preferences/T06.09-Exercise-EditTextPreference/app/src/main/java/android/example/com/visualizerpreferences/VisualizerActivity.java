...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        loadMinimumSizeFrom(sharedPreferences);
    ...
    private void loadMinimumSizeFrom(SharedPreferences sharedPreferences) {
        float minSize = Float.parseFloat(sharedPreferences
                .getString(getString(R.string.pref_edit_text_key),
                        getString(R.string.pref_edit_text_value)));
