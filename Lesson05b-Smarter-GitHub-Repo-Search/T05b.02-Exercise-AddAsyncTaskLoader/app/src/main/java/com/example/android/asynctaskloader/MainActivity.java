...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    static final int GITHUB_SEARCH_LOADER = 22;
    ...
    private void makeGithubSearchQuery() {
        ...
        if (TextUtils.isEmpty(githubQuery)) {
            mUrlDisplayTextView.setText("Search is empty, there isn't anything to search for");
            return;
        }
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                String urlAsString = args.getString(SEARCH_QUERY_URL_EXTRA);

                // TODO (11) If the URL is null or empty, return null
                if (urlAsString == null || TextUtils.isEmpty(urlAsString)) {
                    return null;
                }
                ...
                try {
                    URL searchUrl = new URL(urlAsString);
